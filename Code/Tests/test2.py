# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 14:00:54 2024
...
class Window(QDialog):
    ...
    def getInfo(self):
        ...
        info = "Person Name : {0}".format(self.nameLineEdit.text()) + "\nDegree : {0}".format(self.degreeComboBox.currentText()) + "\nAge : {0}".format(self.ageSpinBar.text())
        file.write(info)
        file.close()
